...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		...
		<form role="form" action="../code/usuario.php" method="post" id="form" name="form" onSubmit="return validar()">
			<table>
				<tr>
					<td><b>Código:</b></td>
					<td>
...
<?php if(isset($_COOKIE["eliminar"])||isset($_COOKIE["modificar"])) { ?> readonly="true" <?php } if(isset($_COOKIE["nombreUsuario"])) { ?> value="<?php echo $_COOKIE["nombreUsuario"]; ?>" <?php } ?> />					</td>
				</tr>
				<tr>
					<td><b>Nombre:</b></td>
					<td>
		...
		<form role="form" action="../code/usuario.php" method="post" id="busqueda" name="busqueda" onClick="return busqueda()">
			<table>
				<tr>
					<td><b>Buscar</b></td>
					<td>&nbsp;</td>
	...
	<table class="table table-hover">
		...
		<tr>
			...
			<td></td>
			<form role="form" action="../code/usuario.php" method="post" id="botonera" name="botonera">
