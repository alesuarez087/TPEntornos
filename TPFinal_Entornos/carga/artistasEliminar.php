...
<div class="col-sm-5 col-md-5">
	...
	<h2 class="page-header">Eliminar Artista</h2>
		...
		<form role="form" action="artistaGUARDAR.php" method="post" id="formTabla" name="formTabla">
			...
			<div class="form-group">
				<b>Nombre:(*)</b>
				<input type="text" class="form-control" id="nombreArtista" name="nombreArtista" value="<?php echo $fila[1] ?>" readonly />
			</div>
			<div class="form-group">
				<b>Habilitado:(*)</b>
				<input type="checkbox" class="checkbox" id="habilitado" name="habilitado" checked="checked" readonly />
			</div>
			<br />
