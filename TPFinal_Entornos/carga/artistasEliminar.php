	...
	<h2 class="page-header">Eliminar Artista</h2>
		...
		<form role="form" action="artistaGUARDAR.php" method="post" id="formTabla" name="formTabla">
			<div class="form-group">
				<b>Id artista:</b>
				<input type="text" class="form-control" id="idArtista" name="idArtista" value="<?php echo $fila[0]; ?>" readonly="true" />
			</div>
			<div class="form-group">
				<b>Nombre:</b>
				<input type="text" class="form-control" id="nombreArtista" name="nombreArtista" value="<?php echo $fila[1] ?>" readonly="true" />
			</div>
			<div class="form-group">
				<b>Habilitado:</b>
