...
<body>
	...
	<h2 class="page-header">Eliminar G&eacute;nero</h2>
		...
		?>
		<form  action="generoGUARDAR.php" method="post" id="formTabla" name="formTabla">
			<div class="form-group">
				<b>C&oacute;digo:(*)</b>
				<input type="text" class="form-control" id="idGenero" name="idGenero" readonly="readonly" value="<?php echo $fila[0]; ?>" />
			</div>
			<div class="form-group">
				<b>Nombre:(*)</b>
				<input type="text" class="form-control" id="descGenero" readonly="readonly" name="descGenero" value="<?php echo $fila[1]; ?>" />
			</div>
			<div class="form-group">
				<b>Habilitado:(*)</b>
				<input type="checkbox" class="checkbox" id="habilitado" readonly="readonly" name="habilitado" <?php if($fila[2]==1) { ?> checked="checked" <?php } ?> />
			</div>
			<br />
		...
		<br /> <br /> <br />
		<form  action="generoONE.php" method="post" id="busqueda" name="busqueda" onclick="return busqueda()">
			<table>
				<tr>
					<td><b>Buscar</b></td>
					<td>&nbsp;</td>
	...
	<table class="table table-hover">
		...
		<tr>
			...
			<td></td>
			<form  action="generoONE.php" method="post" id="botonera" name="botonera">
