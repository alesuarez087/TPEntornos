        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <form>
			<div>
                ...
                <input type="text" placeholder="Nombre" id="txtNombre" name="txtNombre" class="form-control col-sm-6" required="required" />
            </div>
			<div>
  	          	<label class="form-text">Días</label>
                <input type="text" placeholder="Lunes, Martes, Miercoles, Jueves" id="txtDias" name="txtDias" class="form-control col-sm-6" required="required" />
            </div>
			<div>
  	          	<label class="form-text">Hora de Inicio</label>
                <input type="text" placeholder="00:00" id="txtHoraInicio" name="txtHoraInicio" class="form-control col-sm-6" required="required" />
            </div>
            <div>
  	          	<label class="form-text">Hora de finalización</label>
                <input type="text" placeholder="00:00" id="txtHoraFin" name="txtHoraFin" class="form-control col-sm-6" required="required" />
            </div>
            <br />
            <div>
